...
\begin{itemize}
    \item \textbf{Cantidad de detenciones preventivas:} Durante la simulación extendida se registraron exactamente \textbf{2 detenciones preventivas} de seguridad (visibles en el Estado 0 de la Figura 4.4). La primera corresponde al bloqueo por desvío crítico de caudal sostenido (aprox. $t=100s$) y la segunda al apagado automático por agotamiento de la bolsa de infusión transcurrida su ventana de gracia (aprox. $t=800s$).
